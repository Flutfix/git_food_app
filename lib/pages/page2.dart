          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 3),
                Text('Начинайте заботиться о своем здоровье прямо сейчас', 
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 3),
                Text('Тренер составит персональную программу питания и будет вести подсчет КБЖУ', 
                textAlign: TextAlign.center,
                style: TextStyle(
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 3),
                Text('Достигайте своих целей и следите за прогрессом', 
                textAlign: TextAlign.center,
                style: TextStyle(      
                color: Colors.black,
                shadows: <Shadow>[
